...
function filterData(isPagination = false) {
    ...
    $.ajax({
        url: '/bc_thong_ke_theo_ma_benh_icd/filter',
        type: 'POST',
        data: payload,
...
function doExportExcel(finalData, btn, originalHtml) {
    ...
    $.ajax({
        url: '/bc_thong_ke_theo_ma_benh_icd/export/excel',
        type: 'POST',
        ...
        success: function (data, status, xhr) {
            ...
            a.href = url;
            a.download = `BCThongKeTheoMaBenhICD_${requestData.fromDate || 'all'}_den_${requestData.toDate || 'now'}.xlsx`;
...
function doExportPdf(finalData, btnElem) {
    ...
    fetch("/bc_thong_ke_theo_ma_benh_icd/export/pdf", {
        method: "POST",
