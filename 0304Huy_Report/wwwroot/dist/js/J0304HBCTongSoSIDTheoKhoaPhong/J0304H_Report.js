...
function filterData(isPagination = false) {
    ...
    $.ajax({
        url: '/bao_cao_tong_so_SID_theo_khoa_phong/filter',
        type: 'POST',
        data: payload,
...
function doExportExcel(finalData, btn, originalHtml) {
    ...
    $.ajax({
        url: '/bao_cao_tong_so_SID_theo_khoa_phong/export/excel',
        type: 'POST',
...
function doExportPdf(finalData, btnElem) {
    ...
    fetch("/bao_cao_tong_so_SID_theo_khoa_phong/export/pdf", {
        method: "POST",
