...
public interface I0304BBCHoaDonDienTuDVService
{
    ...
    Task<byte[]> ExportBaoCaoHDDTDVPdfAsync(ExportRequest request, ISession session);
    Task<byte[]> ExportBaoCaoHDDTDVExcelAsync(ExportRequest request, ISession session);
}