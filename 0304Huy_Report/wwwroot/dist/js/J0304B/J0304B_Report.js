...
function filterData(isPagination = false) {
    ...
    $.ajax({
        url: '/bao_cao_hoa_don_dien_tu_dich_vu/filter',
        type: 'POST',
        data: payload,
...
function doExportExcel(finalData, btn, originalHtml) {
    ...
    $.ajax({
        url: '/bao_cao_hoa_don_dien_tu_dich_vu/export/excel',
        type: 'POST',
        ...
        success: function (data, status, xhr) {
            ...
            a.href = url;
            a.download = `BaoCaoHoaDonDienTuDichVu_${requestData.fromDate || 'all'}_den_${requestData.toDate || 'now'}.xlsx`;
