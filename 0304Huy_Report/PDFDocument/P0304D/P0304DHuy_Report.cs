                    ...
                    col.Item().Table(table =>
                    {
                        ...
                        foreach (var nv in nhanVienTruCuoi)
                        {
                            ...
                            table.Cell().ColumnSpan(12).Border(1).Padding(3).Element(container =>
                            {
                                container.Row(row =>
                                {
                                    row.ConstantItem(25 + 50 + 45 + 50 + 50).ExtendHorizontal().AlignLeft().Text($"Nhân viên: {nv.Ten}").FontSize(7).Bold();
                        ...
                        table.Cell().ColumnSpan(12).Border(1).Padding(3).Element(container =>
                        {
                            container.Row(row =>
                            {
                                row.ConstantItem(25 + 50 + 45 + 50 + 50).ExtendHorizontal().AlignLeft().Text($"Nhân viên: {nvCuoi.Ten}").FontSize(7).Bold();
                                row.RelativeItem(2).Text("");
                                row.RelativeItem(1).Text("");
                                row.RelativeItem(1).Text("");
